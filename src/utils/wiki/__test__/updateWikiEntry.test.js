...
import { updateWikiEntry } from "../wikiUtil";

describe("updateWikiEntry", () => {
   ...
   it("should return the information of the newly added country if updated successfully", async () => {
      ...
      const newCountry = await updateWikiEntry(mockRequestBody);
   ...
   it("should console.log information of an error with a response property", async () => {
      ...
      const countries = await updateWikiEntry(mockRequestBody);
