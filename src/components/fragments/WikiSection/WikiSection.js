...
function NewDesign() {
   ...
   const handleCountrySelect = (country) => {
    ...
    <Box sx={{height: 'calc(100vh - 80px)', bgcolor: 'white',  display: "flex",   alignItems:"center",  justifyContent:"center"}}>
        <Box
            sx={{
        ...
        >
            ...
            >
            <Box sx={{bgcolor: 'black', width:'90%', borderRadius: 1, marginTop: '10px', marginBottom: '5px'}}><Typography variant='h5' sx={{color: 'white'}}>Filters</Typography></Box>
            <Box sx={{width: '90%'}}>
            {PMESII.map((item, i) => (
               <div>
                ...
                <FormControlLabel
                    ...
                    label={<Typography sx={{fontWeight: 'bold'}}>{item}</Typography>}
                    control={
                      <Checkbox
            ...
            >
                <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-around', width: '94%', marginTop: '10px', marginBottom: '10px'}}> 
                    <FormControl sx={{width: 400, fontFamily: 'inter', marginTop: '5px'}}>
                        <Select
                    ...
                    sx={{width: 125, background: "#690005", maxHeight: '50px', ':hover': {
                        bgcolor: "black",
                        color: 'white',
                        }
                    }}>
                    <Typography >Edit <br/>Country</Typography>
                    </Button>
                    <Button variant="contained" sx={{width: 125, background: "#690005", maxHeight: '50px', ':hover': {
                        bgcolor: "black",
                        color: 'white',
                        }}}>
                    <Typography>New <br/>Country</Typography>
                    </Button>
                    <Button variant="contained" sx={{width: 125, background: "#690005", maxHeight: '50px', ':hover': {
                        bgcolor: "black",
                        color: 'white',
                        }}}>
                    <Typography sx={{fontFamily: 'inter'}}>New <br/>Entry</Typography>
                    </Button>
                    <Button variant="contained" sx={{background: 'transparent', border: 1, borderColor: "#690005", color: "#690005" , maxHeight: '50px',':hover': {
                        bgcolor: "black",
                        color: 'white',
                        } }}>
                    <Typography>User <br/>View</Typography>
                    </Button>
                    
                </Box>

                <Box component="main" sx={{ flexGrow: 1, background: "#D7CEC7", width: '94%', overflowY: 'scroll'}}>
                {PMESII.map((item, i) => (
                    <div>
                    {selectedPMESII[i] && (
                    <Accordion defaultExpanded sx={{border: 1, borderColor: 'black'}}>
                        <AccordionSummary
                        expandIcon={<ArrowDropDownIcon />}
                        aria-controls="panel1-content"
                        id="panel1-header"
